...
define([
  ...
  'plugins/docker-volume-plugin/scripts/controllers/dvol-edit-datastores.js',
  //
  // Services
  //
  ...
  .controller({
    ...
    'DvolEditDatastoresController': DvolEditDatastoresController
  })
  .service({
